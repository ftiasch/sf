...
| zero : bin
| twice : bin -> bin
| one_more_than_twice : bin -> bin.

Fixpoint incr (b : bin) : bin :=
  match b with
    | zero => one_more_than_twice zero
    | twice b' => one_more_than_twice b'
    | one_more_than_twice b' => twice (incr b')
  end.
...
Fixpoint bin_to_nat (b : bin) : nat :=
  match b with
    ...
    | one_more_than_twice b' => S (bin_to_nat b' + bin_to_nat b')
  end.
(** [] *)
